...
fn test_instructions_dataset_and_search() {
    ...
    let expected_x86_64 = [
        "mov", "movzx", "movsx", "movsxd", "xor", "xadd", "cmpxchg", "push", "pop", "jmp",
        "call", "ret", "syscall", "inc", "dec", "neg", "not", "add", "sub", "shl",
        "shr", "sar", "rol", "ror", "lea", "cmp", "test", "nop", "cdq", "cqo",
        "xchg", "lodsb", "stosb", "rep movsb", "rep stosb", "repne scasb", "cld", "std", "leave", "enter",
        "int3", "ud2", "cpuid", "rdtsc", "rdtscp", "rdrand", "lahf", "sahf", "bt", "bts",
        "btr", "btc", "bsf", "bsr", "popcnt", "lzcnt", "tzcnt", "loop", "fldz", "fnstenv",
    ];
    ...
    let expected_x86 = [
        "mov", "movzx", "movsx", "xor", "push", "pop", "jmp", "call", "ret", "int 0x80",
        "sysenter", "inc", "dec", "neg", "not", "add", "sub", "shl", "shr", "sar",
        "rol", "ror", "lea", "cmp", "test", "nop", "cdq", "cltd", "xchg", "lodsb",
        "stosb", "rep movsb", "rep stosb", "repne scasb", "cld", "std", "leave", "enter", "int3",
        "ud2", "cpuid", "rdtsc", "rdrand", "lahf", "sahf", "bt", "bts", "btr", "btc",
        "bsf", "bsr", "popcnt", "loop", "fldz", "fnstenv",
    ];
...
fn test_contains_case_insensitive() {
    ...
    assert!(!contains_case_insensitive("Intel Syntax", "longer_than_haystack"));
}
