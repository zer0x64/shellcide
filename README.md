...
You can find an online demo(does not support debugging) here: [Shellcide Online Demo](https://zer0x64.github.io/projects/shellcide/index.html)
...
## Installation
To install the project, you can simply install it using cargo:
```bash
